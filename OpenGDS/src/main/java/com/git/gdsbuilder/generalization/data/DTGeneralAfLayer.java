...
public class DTGeneralAfLayer {
	 ...
	 * @throws 
	 * */
	public DTGeneralAfLayer generalization(DTGeneralPreLayer preLayer, GeneralizationOrder order) throws IOException{
		return (new Generalization(preLayer,order)).getGeneralzation();
	}
}

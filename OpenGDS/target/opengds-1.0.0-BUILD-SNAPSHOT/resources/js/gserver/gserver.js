...
function addServerAjax(){
    var serverCase = {
	    serverName          : {type : "text", name : "server name", required : true},
	    serverURL         : {type : "text", name : "URL", required : true},
	    serverID        : {type : "text", name : "ID", required : true},
	    serverPW        : {type : "text", name : "password", required : true},
    };
